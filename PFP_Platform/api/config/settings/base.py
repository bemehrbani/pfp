"""
Django base settings for PFP Campaign Manager.
"""
import os
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://pfp_user:pfp_password@localhost:5432/pfp_campaign',
        conn_max_age=600
    )
}
...
# Channels settings (Redis as channel layer)
CHANNEL_LAYERS = {
    'default': {
...
TELEGRAM_NOTIFICATIONS_CHAT_ID = os.environ.get('TELEGRAM_NOTIFICATIONS_CHAT_ID', '')
