...
TRANSLATIONS = {
    ...
    "simplified_escalation_creator_prompt": {
        "en": "Awesome! To help us team up, please send a link to your portfolio, main social media profile, or describe your skills (e.g., video editing, graphic design, writing).",
        "fa": "عالی! برای اینکه بتوانیم با هم همکاری کنیم، لطفاً لینکی از نمونه کارها، رسانه اجتماعی اصلی خود یا توضیح مهارت‌هایتان (مانند ویرایش ویدئو، طراحی گرافیک، نویسندگی) بفرستید.",
        "ar": "رائع! لمساعدتنا على التعاون، يرجى إرسال رابط لمحفظتك أو ملفك الشخصي الرئيسي على وسائل التواصل الاجتماعي أو وصف مهاراتك (مثل تحرير الفيديو أو تصميم الجرافيك أو الكتابة).",
    },
}
